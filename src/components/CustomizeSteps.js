  ...
  return (
    <div className="flex flex-col pl-2 gap-4 h-full overflow-auto">
        ...
        <div className='p-2 bg-blue-500 w-80 rounded-md'>
            <label htmlFor='char-1-input'>Char 1 Steps </label>
            <input id="char-1-input" type='number' min={1} className='text-black' value={char1Steps} onChange={e => setChar1Steps(e.target.value)}/>
        </div>
        <div className='p-2 bg-blue-500 w-80 rounded-md'>
            <label htmlFor='char-1-input'>Char 1 Steps </label>
            <input id="char-1-input" type='number' min={1} className='text-black' value={char2Steps} onChange={e => setChar2Steps(e.target.value)}/>
        </div>
    </div>
  )
}
